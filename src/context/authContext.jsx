...
export const AuthContextProvider = ({ children }) => {
  ...
  const [CRUDtoken, setCRUDtoken] = useState(localStorage.getItem("CRUDtoken") || "");
  ...
  return (
    <AuthContext.Provider value={{ isLogin, loading, user, CRUDtoken, githubLogin, githubLogout }}>
      {children}
